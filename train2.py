...
dir_dataset = Path('../building-map-generator-datasets/Inria_256')

dir_data = dir_dataset/"train/images"
dir_label = dir_dataset/"train/gt"

dir_output = Path('./checkpoints/')
run_name = "Inria_256_b10"
...
def train_net(net,
    ...
    # 1. Create dataset and split into train_set and val_set

    
    dataset = BasicDataset(dir_data, dir_label, img_scale)
    # val_dataset = BasicDataset(dir_data/"val", dir_label/"val", img_scale)
    # print(dataset.__getitem__(0)['label'].shape)  # torch.Size([256, 256]) torch.Size([128, 128])
    # print(dataset.__getitem__(0)['data'].shape)   # torch.Size([256, 256, 3])  torch.Size([3, 128, 128])
    # print(dataset.__getitem__(0)['label'].dtype)  # int64
    # print(dataset.__getitem__(0)['data'].dtype)   # float32

    # print(dataset.__getitem__(0)['data'])   # torch.Size([256, 256, 3])  torch.Size([3, 128, 128])
    # print(dataset.__getitem__(0)['data'].sum())   # torch.Size([256, 256, 3])  torch.Size([3, 128, 128])
    # print(dataset.__getitem__(0)['label'])   # torch.Size([256, 256, 3])  torch.Size([3, 128, 128])
    # print(dataset.__getitem__(0)['label'].sum())   # torch.Size([256, 256, 3])  torch.Size([3, 128, 128])
    # exit()
